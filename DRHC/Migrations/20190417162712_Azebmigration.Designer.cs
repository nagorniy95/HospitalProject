...
namespace DRHC.Migrations
{
    ...
    [Migration("20190417162712_Azebmigration")]
    partial class Azebmigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DRHC.Models.Guest", b =>
                {
            ...
            modelBuilder.Entity("DRHC.Models.Menu", b =>
                {
            ...
            modelBuilder.Entity("DRHC.Models.Order", b =>
                {
            ...
            modelBuilder.Entity("DRHC.Models.OrderXMenu", b =>
                {
                    b.Property<int>("OrderID");
            ...
            modelBuilder.Entity("DRHC.Models.Order", b =>
                {
                    b.HasOne("DRHC.Models.Guest", "Guests")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("DRHC.Models.OrderXMenu", b =>
                {
                    b.HasOne("DRHC.Models.Menu", "Menu")
                        .WithMany("Ordersxmenus")
                        .HasForeignKey("ItemID")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("DRHC.Models.Order", "Order")
                        .WithMany("Ordersxmenus")
